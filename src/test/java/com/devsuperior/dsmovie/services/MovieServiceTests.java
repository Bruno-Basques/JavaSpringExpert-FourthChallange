...
public class MovieServiceTests {
	...
	private PageImpl<MovieEntity> pageOfMovieEntities;
	...
	void setUp() throws Exception {
		...
		pageOfMovieEntities = new PageImpl<>(List.of(movieEntity));		
		existingMovieId = 1L;
		nonExistingMovieId = 2L;
		dependentMovieId = 3L;
		
		Mockito.when(repository.searchByTitle(any(), (Pageable)any())).thenReturn(pageOfMovieEntities);
